          ...
          children: [
                      ...
                      SliverToBoxAdapter(
                        child: Row(
                          ...
                          children: [
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (BuildContext ctx) => ReviewScreen(movieId: movie.id.toString(),)));
                              },
                              child: Column(
                                children: [
                                  const SizedBox(
                            ...
                            GestureDetector(
                              onTap: () {
                                Navigator.push(context, MaterialPageRoute(builder: (BuildContext ctx) => AddRatingScreen(movieId: movie.id.toString(),)));
                              },
                              child: Column(
                                children: [
                                  const SizedBox(
            ...
            Align(
              ...
              child: MaterialButton(
                ...
                onPressed: () {
                   Navigator.push(context, MaterialPageRoute(builder: (BuildContext ctx) => BookingMovie(movieDetailBloc: movieDetailBloc,)));
                },
                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(0.0)),
                child: Text('BUY TICKET', style: TextStyle(color: AppColor.white, fontWeight: AppFontWeight.medium, fontSize: AppFontSize.medium),),
              ),
            )
          ],
        ));
