...
import 'package:app_movie/screens/home/detail/home_movie_detail_2.dart';
...
class ItemSimilar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(builder: (ctx) => HomeMovieDetail2(id: movie.id.toString(),)));
      },
      child: Container(
        width: 140,
